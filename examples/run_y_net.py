...
maps = ['pm']#'identity','heat','pm']
sigma = [1e-4]
tdens2image_scaling = [1e1]


parameters=[examples,nref,fems,mask,gamma,wd,wr,ini,conf,maps,sigma,tdens2image_scaling]
combinations = list(itertools.product(*parameters))
print(combinations)



def fun(example,nref,fem,mask,gamma,wd,wr,ini,conf,tdens2image,sigma,tdens2image_scaling):
