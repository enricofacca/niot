...
wd = [1e-1,1e0]#,1e-5,1e-3,1e-1
wr = [1e-1]
ini = [1e5]
network_file = ['network.png','mup3.0e+00zero5.0e+05.npy']#,'mupou3.0e+00zero5.0e+05.npy']#,'mucnstp3.0e+00zero5.0e+05.npy','muthickness.npy']
